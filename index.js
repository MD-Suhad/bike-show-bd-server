...
// mongodb+srv://<username>:<password>@realmcluster.bmile.mongodb.net/myFirstDatabase?retryWrites=true&w=majority


const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@realmcluster.bmile.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
...
async function run() {
  try{
    ...
    const database = client.db("bikeshowbd");
